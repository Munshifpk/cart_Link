      ...
      child: InkWell(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              '$count products',
              style: const TextStyle(fontSize: 11, color: ThemeColors.textSecondary),
            ),
            const SizedBox(height: 4),
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                const Icon(Icons.star, size: 12, color: ThemeColors.success),
                const SizedBox(width: 2),
                Text(
                  rating,
                  style: const TextStyle(fontSize: 10, color: ThemeColors.textSecondary),
                ),
              ],
            ),
          ],
