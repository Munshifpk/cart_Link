...
class ShopService {
  static Future<Map<String, dynamic>> getAllShops() async {
    try {
      final resp = await http.get(Uri.parse(_backendUrl)).timeout(const Duration(seconds: 10));
  ...
  static Future<Map<String, dynamic>> updateShop(String id, Map<String, dynamic> payload) async {
